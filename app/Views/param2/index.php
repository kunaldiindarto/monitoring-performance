                    ...
                    <?php foreach ($oee as $o) : ?>
                        <tr>
                            ...
                            <?php if (has_permission('manage-users')) : ?>
                                <td>
                                    <a href="/param2/edit/<?= $o['id']; ?>" class="btn btn-info"> Edit</a>

                                    <form action="/param2/<?= $o['id']; ?>" method="post" class="d-inline">
                                        <?= csrf_field(); ?>
                    ...
                    <?php foreach ($performance as $keyy => $valuee) : ?>
                        <tr>
                            ...
                            <?php if (has_permission('manage-teknik')) : ?>
                                <td>
                                    <a href="/performance/edit2" class="btn btn-success"> Input</a>
                                </td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                    ...
                    <?php foreach ($quality as $key => $value) : ?>
                        <tr>
                            ...
                            <?php if (has_permission('manage-quality')) : ?>
                                <td>
                                    <a href="/quality/edit2/<?= $value->id ?>" class="btn btn-success"> Input</a>
                                </td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                ...
                <tbody>
                    <?php foreach ($lifetime as $l => $nilai) : ?>
                        <tr>
                            ...
                            <td><?= $nilai->menit; ?></td>
                            <?php if (has_permission('manage-teknik')) : ?>
                                <td><a href="/lifetime/edit2/<?= $nilai->id ?>" class="btn btn-success"> Input</a></td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
