...
<script>
    ...
    function dataAjax(params) {
        return fetch('<?= base_url(); ?>/mesin/m2data', {
                method: "get",
                headers: {
    ...
    async function getProcess() {
        try {
            ...
            console.log(data);
            let process = data.process[0].process2;
    ...
    function lifeTime(data) {
        ...
        if (sakelar_M1 === "on2" && blinkData !== "sd") {
            ...
            } else if (sakelar_M1 === "on2" && hari < 1 && jam > 1) {
                tempelLifetime.innerHTML = +hari + " : " + jam + " : " + menit + " : " + detik;
                satuanLifetime.innerHTML = "D : H : M : S";
    ...
    function processChart(data) {
        ...
        dataProses.forEach(dataProses => {
            nilaiProses.push(dataProses.process2);
        });
