...
<script>
    ...
    function dataAjax(params) {
        return fetch('<?= base_url(); ?>/mesin/m3data', {
                method: "get",
                headers: {
    ...
    async function getProcess() {
        try {
            ...
            console.log(data);
            let process = data.process[0].process3;
    ...
    function lifeTime(data) {
        ...
        if (sakelar_M1 === "on3" && blinkData !== "sd") {
            ...
            } else if (sakelar_M1 === "on3" && hari < 1 && jam > 1) {
                tempelLifetime.innerHTML = +hari + " : " + jam + " : " + menit + " : " + detik;
                satuanLifetime.innerHTML = "D : H : M : S";
    ...
    function statusMesin1(data) {
        ...
        console.log("status m3 adlah " + statM1);
        if (statM1 === "on3" && blink === "off") {
    ...
    function mtbfChart(data) {
        ...
        // ?dam untuk nilai array karena mulainya 0
        dam -= 1;
        const nilaiMTBF = data.maintenance[dam].mtbf
        ...
        Plotly.newPlot('mtbf', hasil, layoutt, configure);
    ...
    function mttrChart(data) {
        ...
        dan -= 1;
        const nilaiMTTR = data.maintenance[dan].mttr
        ...
        Plotly.newPlot('mttr', hasil2, layouttt, configurera);
    ...
    function processChart(data) {
        ...
        dataProses.forEach(dataProses => {
            nilaiProses.push(dataProses.process3);
        });
